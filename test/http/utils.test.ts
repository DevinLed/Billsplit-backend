...
describe("HttpResponses", () => {
  ...
  test("should return Updated response", () => {
    const result: APIGatewayProxyResult = HttpResponses.updated({
      status: "success",
    });
    expect(result).toEqual({
      statusCode: HttpStatus.OK,
  ...
  test("should return BadRequest response", () => {
    const result: APIGatewayProxyResult =
      HttpResponses.badRequest("Bad Request");
    expect(result).toEqual({
  ...
  test("should return InternalServerError response", () => {
    const result: APIGatewayProxyResult = HttpResponses.internalServerError(
